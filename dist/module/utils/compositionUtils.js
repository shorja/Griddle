...
function wrapMethodsByWordEnding(componentArray, wordEnding) {
  ...
  return componentArray.reduce(function (previous, current) {
    ...
    var _loop = function _loop() {
      ...
      if (key.endsWith(wordEnding) && (previous.hasOwnProperty(keyWithoutEnhancer) || current.hasOwnProperty(keyWithoutEnhancer))) {
        ...
        if (keyWithoutEnhancer.endsWith('Container') || keyWithoutEnhancer.endsWith('Enhancer')) {
          ...
          newObject[keyWithoutEnhancer] = (0, _flowRight3.default)(current[key], current[keyWithoutEnhancer] || previous[keyWithoutEnhancer]);
        } else {
          // Wrap the current component in the Enhancer or container
          if (Array.isArray(current[key])) {
            newObject[keyWithoutEnhancer] = current[key].reduce(function (previousComponent, currentComponent) {
    ...
    return (0, _pickBy3.default)(Object.assign(mergedObject, newObject), function (v, k) {
