...
var dataLoadingSelector = exports.dataLoadingSelector = (0, _selectorUtils.createSelector)(dataSelector, function (data) {
  return !data;
});
...
var hasPreviousSelector = exports.hasPreviousSelector = (0, _selectorUtils.createSelector)('currentPageSelector', function (currentPage) {
  return currentPage > 1;
});

/** Gets the max page size
 */
var maxPageSelector = exports.maxPageSelector = (0, _selectorUtils.createSelector)('pageSizeSelector', 'recordCountSelector', function (pageSize, recordCount) {
...
var allColumnsSelector = exports.allColumnsSelector = (0, _selectorUtils.createSelector)('dataSelector', 'renderPropertiesSelector', function (data, renderProperties) {
 ...
 */
var sortedColumnPropertiesSelector = exports.sortedColumnPropertiesSelector = (0, _selectorUtils.createSelector)('renderPropertiesSelector', function (renderProperties) {
 ...
 */
var metaDataColumnsSelector = exports.metaDataColumnsSelector = (0, _selectorUtils.createSelector)('sortedColumnPropertiesSelector', function (sortedColumnProperties) {
 ...
 */
var visibleColumnsSelector = exports.visibleColumnsSelector = (0, _selectorUtils.createSelector)('sortedColumnPropertiesSelector', 'allColumnsSelector', function (sortedColumnProperties, allColumns) {
  return sortedColumnProperties ? sortedColumnProperties.filter(function (c) {
 ...
 */
var visibleColumnPropertiesSelector = exports.visibleColumnPropertiesSelector = (0, _selectorUtils.createSelector)('visibleColumnsSelector', 'renderPropertiesSelector', function () {
...
/** TODO: add tests and docs
 */
var hiddenColumnPropertiesSelector = exports.hiddenColumnPropertiesSelector = (0, _selectorUtils.createSelector)('hiddenColumnsSelector', 'renderPropertiesSelector', function () {
...
*/
var columnIdsSelector = exports.columnIdsSelector = (0, _selectorUtils.createSelector)('renderPropertiesSelector', 'visibleColumnsSelector', function (renderProperties, visibleColumns) {
  var offset = 1000;
 ...
 */
var columnTitlesSelector = exports.columnTitlesSelector = (0, _selectorUtils.createSelector)('columnIdsSelector', 'renderPropertiesSelector', function (columnIds, renderProperties) {
...
var visibleRowIdsSelector = exports.visibleRowIdsSelector = (0, _selectorUtils.createSelector)('dataSelector', function (currentPageData) {
