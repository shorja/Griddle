 ...
 */
var visibleRecordCountSelector = exports.visibleRecordCountSelector = (0, _selectorUtils.createSelector)('rowHeightSelector', 'currentHeightSelector', function (rowHeight, currentHeight) {
  return Math.ceil(currentHeight / rowHeight);
});

var visibleDataLengthSelector = exports.visibleDataLengthSelector = (0, _selectorUtils.createSelector)('sortedDataSelector', function (sortedData) {
...
var startIndexSelector = exports.startIndexSelector = (0, _selectorUtils.createSelector)('verticalScrollChangeSelector', 'rowHeightSelector', 'visibleRecordCountSelector', function (verticalScrollPosition, rowHeight, visibleRecordCount) {
  // Inspired by : http://jsfiddle.net/vjeux/KbWJ2/9/
  return Math.max(0, Math.floor(Math.floor(verticalScrollPosition / rowHeight) - visibleRecordCount * 0.25));
});

var endIndexSelector = exports.endIndexSelector = (0, _selectorUtils.createSelector)('startIndexSelector', 'visibleRecordCountSelector', 'visibleDataLengthSelector', function (startDisplayIndex, visibleRecordCount, visibleDataLength) {
  // Inspired by : http://jsfiddle.net/vjeux/KbWJ2/9/
  return Math.min(Math.floor(startDisplayIndex + visibleRecordCount * 2), visibleDataLength - 1) + 1;
});

var topSpacerSelector = exports.topSpacerSelector = (0, _selectorUtils.createSelector)('rowHeightSelector', 'startIndexSelector', function (rowHeight, startIndex) {
  return rowHeight * startIndex;
});

var bottomSpacerSelector = exports.bottomSpacerSelector = (0, _selectorUtils.createSelector)('rowHeightSelector', 'visibleDataLengthSelector', 'endIndexSelector', function (rowHeight, visibleDataLength, endIndex) {
...
var currentPageDataSelector = exports.currentPageDataSelector = function currentPageDataSelector() {
  return (0, _selectorUtils.createSelector)('sortedDataSelector', 'startIndexSelector', 'endIndexSelector', function (sortedData, startDisplayIndex, endDisplayIndex) {
