...
var doesCellNeedUpdate = exports.doesCellNeedUpdate = function () {
  var prevStateMemo = null;
  var nextStateMemo = null;
  var outputMemo = null;
  return function (prevState, nextState) {
    if (prevState !== prevStateMemo || nextState !== nextStateMemo) {
      ...
      outputMemo = prevState.getIn(['data']) === nextState.getIn(['data']) && (prevState.getIn(['renderProperties']) === nextState.getIn(['renderProperties']) || prevState.getIn(['renderProperties', 'columnProperties']) === nextState.getIn(['renderProperties', 'columnProperties']));
      return outputMemo;
    } else {
      return outputMemo;
    }
...
var doesRowNeedUpdate = exports.doesRowNeedUpdate = function () {
  var prevStateMemo = null;
  var nextStateMemo = null;
  var outputMemo = null;
  return function (prevState, nextState) {
    if (prevState !== prevStateMemo || nextState !== nextStateMemo) {
      prevStateMemo = prevState;
      nextStateMemo = nextState;
      outputMemo = prevState.getIn(['data']) === nextState.getIn('data') && (prevState.get('renderProperties') === nextState.get('renderProperties') || prevState.getIn(['renderProperties', 'rowProperties']) == nextState.getIn(['renderProperties', 'rowProperties'])) && (prevState.getIn(['styleConfig']) === nextState.getIn(['styleConfig']) || prevState.getIn(['styleConfig', 'classNames']) === nextState.getIn(['styleConfig', 'classNames'])) && (prevState.getIn(['styleConfig']) === nextState.getIn(['styleConfig']) || prevState.getIn(['styleConfig', 'styles']) === nextState.getIn(['styleConfig', 'styles']));
      return outputMemo;
    } else {
      return outputMemo;
    }
